...
public final class SpoolCommand extends AbstractCommand {
	...
	private void openSpool(String filename) throws IOException {
		// open file
		OutputDevice spool = new PrintStreamOutputDevice(new PrintStream(
				new FileOutputStream(filename)));
		henplus.setOutput(openStackedDevice(_outStack, spool),
	...
	private boolean closeSpool() throws IOException {
		...
		henplus.setOutput(closeStackedDevice(_outStack),
