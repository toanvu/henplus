...
public class ImportCommand extends AbstractCommand {
    ...
    public ImportCommand(ListUserObjectsCommand tc, HenPlus henplus) {
        ...
        */
        ...
        try {
            ...
            if ("import-print".equals(cmd)) {
                innerRecipient = new PrintRecipient(config.getColumns(), henplus);
            }
    ...
    private final class PrintRecipient implements RowCountingRecipient {
        private final String[] _paddedNames;
        private long _rows;
        private boolean _colWritten;
        private HenPlus henplus;

        public PrintRecipient(String[] columnNames,HenPlus henplus)
        {
            _rows = 0;
            int maxLen = -1;
            int maxIndex = 0;
    ...
    private final class ConfigurationParser {
    ...
    private final class TableCompleterFactory 
        implements CompleterFactory {
        public Iterator getCompleter(ConfigurationParser parser,
                                     String partialName) {
            return parser.getTableCompleter()
                .completeTableName(henplus.getCurrentSession(),
                                   partialName);
        }
    }
