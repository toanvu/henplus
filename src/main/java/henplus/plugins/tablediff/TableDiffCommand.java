...
public final class TableDiffCommand extends AbstractCommand {
     ...
     * 
     */
    public TableDiffCommand(HenPlus henplus) {
    ...
    private int executeDoubleDb( StringTokenizer st, boolean colNameIgnoreCase) {
        ...
        SessionManager sessionManager = henplus.getSessionManager();
        ...
        try {
            ...
            ListUserObjectsCommand objectLister = henplus.getObjectLister();
    ...
    private void diffTable(
        ...
        if (diffResult == null) {
            ...
            ResultTablePrinter.printResult(diffResult,henplus);
        }
    }
    ...
    public Iterator complete(CommandDispatcher disp, 
        ...
        if ( argIndex == 0 && lastWord.startsWith( "-" ) ) {
            ...
            ListUserObjectsCommand objectList = henplus.getObjectLister();
        ...
        // !singledb && process the first session
                ...
                && argIndex == 0) {
            return henplus.getSessionManager().completeSessionName(lastWord);
        }
    ...
    private Iterator getSecondSessionCompleter(String lastWord, final String firstSession) {
        final Iterator it = henplus.getSessionManager().completeSessionName(lastWord);
        return new Iterator() {
            String session = null;
            public boolean hasNext() {
                while (it.hasNext()) {
