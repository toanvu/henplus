...
//    int execute(SQLSession session, String command, String parameters);
     ...
     *
     * @param disp the CommandDispatcher - you might want to access
     *             other values through it.
     ...
     *
     * <p>This method is called, whenever the input encounters a newline or
     ...
     * might not be true.
     * <ul>
     *  <li>'select * from foobar' is not complete after a return, since we can
     ...
     *
     * @param command the partial command read so far given to decide by
     *                the command whether it is complete or not.
     */
